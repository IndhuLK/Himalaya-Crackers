...
const DeliveryAreas = () => {
  ...
  return (
    <section className="py-16 bg-[#F8FAFC] font-poppins relative">
        ...
        <div className="flex flex-col lg:flex-row gap-10 items-center">
          ...
          <div className="lg:w-1/2 space-y-6">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
              <div className="p-4 bg-white rounded-xl shadow-md border-l-4 border-[#1E60F2]">
              ...
              <div className="p-4 bg-white rounded-xl shadow-md border-l-4 border-[#F2A31E]">
                <div className="flex items-center gap-3 mb-2">
            ...
            <button
              className="flex items-center gap-2 px-6 py-3 bg-[#1E60F2] cursor-pointer
          ...
          <div className="lg:w-1/2 w-full relative">
            ...
            <div
              className="relative z-10 bg-white rounded-[3rem] p-8 shadow-2xl border
             border-gray-100 overflow-hidden min-h-100 flex items-center justify-center "
            >
